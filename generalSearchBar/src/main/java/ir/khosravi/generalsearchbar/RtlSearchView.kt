package ir.khosravi.generalsearchbar
...
import kotlinx.android.synthetic.main.view_generalsearchbar.view.*


class RtlSearchView @JvmOverloads constructor(
    context: Context?,
    ...
    private fun setupAttributes(attrs: AttributeSet) {
        LayoutInflater.from(context).inflate(R.layout.view_generalsearchbar, this, true)
        ...
        input_search.addTextChangedListener { charSequence ->
            try {
                ...
                val drawableRes: Int =
                    if (TextUtils.isEmpty(query)) R.drawable.outline_search_24 else 0
    ...
    private fun updateViewsVisibility() {
        when (searchState) {
            ...
            SearchState.ReadyToType -> {
                ...
                input_search.setCompoundDrawablesWithIntrinsicBounds(
                    0, 0, R.drawable.outline_search_24, 0
                )
            }
            SearchState.QueryTyping -> {
                btn_clear.visibility = View.VISIBLE
